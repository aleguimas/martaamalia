      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start order-1 lg:order-1">
            ...
            <div className="relative z-20">
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-2xl lg:rounded-[2rem] shadow-xl lg:shadow-2xl p-4 lg:p-8 transform -rotate-1 lg:-rotate-1 hover:rotate-0 transition-all duration-500 hover:scale-105">
                  {/* Inner Frame with Border */}
                  <div className="relative bg-gradient-to-br from-pink-50 via-white to-rose-50 rounded-xl lg:rounded-[1.5rem] p-3 lg:p-6 border border-pink-100">
                    {/* Image Container */}
                    <div className="relative w-64 h-80 sm:w-72 sm:h-88 lg:w-80 lg:h-96 xl:w-96 xl:h-[480px] overflow-hidden rounded-xl lg:rounded-2xl">
                      <Image
          ...
          <div className="order-2 lg:order-2">
            ...
            <div className="mb-6 lg:mb-8">
              <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-3 lg:mb-4">Formação e Especializações</h3>
              <div className="space-y-2 lg:space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm lg:text-base text-gray-700">Esteticista Cosmetóloga</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-4 h-4 lg:w-5 lg:h-5 text-pink-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm lg:text-base text-gray-700">Especialista em Drenagem Linfática</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-4 h-4 lg:w-5 lg:h-5 text-pink-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm lg:text-base text-gray-700">Terapias Manuais e Pós-cirúrgicos</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-4 h-4 lg:w-5 lg:h-5 text-pink-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-sm lg:text-base text-gray-700">Design de Sobrancelhas e Depilação</span>
                </div>
              </div>
            </div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 lg:px-6 rounded-lg transition-colors duration-200 text-sm lg:text-base"
            >
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-8">
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold text-pink-600 mb-1 lg:mb-2">500+</div>
            <div className="text-xs lg:text-sm text-gray-600">Clientes Atendidas</div>
          </div>
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold text-pink-600 mb-1 lg:mb-2">10+</div>
            <div className="text-xs lg:text-sm text-gray-600">Anos de Experiência</div>
          </div>
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold text-pink-600 mb-1 lg:mb-2">8+</div>
            <div className="text-xs lg:text-sm text-gray-600">Tratamentos Especializados</div>
          </div>
          <div className="text-center">
            <div className="text-2xl lg:text-4xl font-bold text-pink-600 mb-1 lg:mb-2">100%</div>
            <div className="text-xs lg:text-sm text-gray-600">Satisfação</div>
          </div>
        </div>
      </div>
    </section>
